...
export const dotted_semiquaver = [
  {note: 'C', icon: require('../assets/dotted_semiquaver.png'), sound: c, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'C#/Db', icon: require('../assets/dotted_semiquaver.png'), sound: csharp, rest: require('../assets/dotted_semiquaver_rest.png')},
  {note: 'D', icon: require('../assets/dotted_semiquaver.png'), sound: d, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'D#/Eb', icon: require('../assets/dotted_semiquaver.png'), sound: dsharp, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'E', icon: require('../assets/dotted_semiquaver.png'), sound: e, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'F', icon: require('../assets/dotted_semiquaver.png'), sound: f, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'F#/Gb', icon: require('../assets/dotted_semiquaver.png'), sound: fsharp, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'G', icon: require('../assets/dotted_semiquaver.png'), sound: g, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'G#/Ab', icon: require('../assets/dotted_semiquaver.png'), sound: gsharp, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'A', icon: require('../assets/dotted_semiquaver.png'), sound: a, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'A#/Bb', icon: require('../assets/dotted_semiquaver.png'), sound: asharp, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'B', icon: require('../assets/dotted_semiquaver.png'), sound: b, rest: require('../assets/dotted_semiquaver_rest.png')}, 
  {note: 'C', icon: require('../assets/dotted_semiquaver.png'), sound: cva, rest: require('../assets/dotted_semiquaver_rest.png')}
];
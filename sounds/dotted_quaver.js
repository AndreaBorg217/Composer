...
export const dotted_quaver = [
  {note: 'C', icon: '../assets/dotted_quaver.png', sound: c, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'C#/Db', icon: '../assets/dotted_quaver.png', sound: csharp, rest: '../assets/dotted_quaver_rest.png'},
  {note: 'D', icon: '../assets/dotted_quaver.png', sound: d, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'D#/Eb', icon: '../assets/dotted_quaver.png', sound: dsharp, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'E', icon: '../assets/dotted_quaver.png', sound: e, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'F', icon: '../assets/dotted_quaver.png', sound: f, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'F#/Gb', icon: '../assets/dotted_quaver.png', sound: fsharp, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'G', icon: '../assets/dotted_quaver.png', sound: g, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'G#/Ab', icon: '../assets/dotted_quaver.png', sound: gsharp, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'A', icon: '../assets/dotted_quaver.png', sound: a, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'A#/Bb', icon: '../assets/dotted_quaver.png', sound: asharp, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'B', icon: '../assets/dotted_quaver.png', sound: b, rest: '../assets/dotted_quaver_rest.png'}, 
  {note: 'C', icon: '../assets/dotted_quaver.png', sound: cva, rest: '../assets/dotted_quaver_rest.png'}
];